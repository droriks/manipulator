...
print(f"solution1 (radians): {solution1}")
print(f"alpha1 raw: {float(solution1[0])} rad")
print(f"beta1 raw:  {float(solution1[1])} rad")
print(f"alpha1: {float(solution1[0])*180/np.pi} deg")
print(f"beta1:  {float(solution1[1])*180/np.pi} deg")